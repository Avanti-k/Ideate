...
with open("/home/avanti/l3/weblog.txt","r") as f:
    for line in f:
        str=line
#str = "216.239.45.4 - - [14/May/2009:14:04:26 -0700] \"GET www.twibuzz.com/ HTTP/1.0\" 200 123355 \"-\" \"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.5; en-US; rv:1.9.0.10) Gecko/2009042315 Firefox/3.0.10\""
#print str.split( );
        temp=str.split( "\"");
        str1=temp[0]
        str2=temp[1]
